                ...
                if SECRET_SENSATION[entry_id] {
                    ...
                    if CAMERA[entry_id] == false { // Exists so all of this code will only happen once.
                        acmd!(lua_state,{
                            ...
                            FILL_SCREEN_MODEL_COLOR(fighter, 0, 3, 0.2, 0.2, 0.2, 0, 0, 0, 1, 1, *smash::lib::lua_const::EffectScreenLayer::GROUND, 205); // Darkens everything on screen except for the Fighters
                        });
                    ...
                    if SEC_SEN_TIMER[entry_id] > 1.0 {
                        ...
                        acmd!(lua_state,{
                            ...
                            CANCEL_FILL_SCREEN(fighter, 0, 5) // Clears out the background screen darken effect.
                        });
